...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  () => [
    ...
    { to: '/tenant-lifecycle', label: 'Ciclo tenant', icon: Archive, permission: 'clients.view' },
    { to: '/invoices', label: 'Facturación', icon: FileText, permission: 'invoices.view' },
    { to: '/biometric-tests', label: 'Test biométrico', icon: Fingerprint, permission: 'settings.view' },
    { to: '/storage-monitor', label: 'Capacidad', icon: HardDrive, permission: 'settings.view' },
