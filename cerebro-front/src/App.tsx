...
import BiometricTestsPage from './pages/BiometricTestsPage'
    ...
    ;(async () => {
      try {
        ...
        applyBranding({
          ...
          button_radius: (s as any)?.button_radius,
          button_style: (s as any)?.button_style,
          button_text_transform: (s as any)?.button_text_transform,
          surface_style: (s as any)?.surface_style,
          background_type: (s as any)?.background_type,
          background_color: (s as any)?.background_color,
          background_image_url: (s as any)?.background_image_url,
          background_overlay_opacity: (s as any)?.background_overlay_opacity,
        })
      } catch {
        applyBranding({})
      }
