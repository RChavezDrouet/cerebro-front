...
const configItems: ConfigItem[] = [
  {
    ...
    description: 'Fuente única de verdad para enrolar empleados, jerarquías y jefaturas.',
    path: '/config/organizacional',
    badge: 'Principal',
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">
          Personaliza el sistema según las necesidades de tu empresa. La estructura organizacional es la única fuente de verdad para ubicar al empleado.
        </p>
      </div>
