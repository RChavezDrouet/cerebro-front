...
const App: React.FC = () => {
  ...
  // Tenant gate: bloquear si el tenant está en estado "paused"
    ...
    return (
      ...
      >
        <div className="nova-card" style={{ padding: 28, maxWidth: 420, width: '100%', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: 16, fontWeight: 800, color: 'var(--nova-text)', marginBottom: 8 }}>Tenant en pausa</div>
  ...
  return (
    <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{ flex: 1 }}>
        ...
        {activeTab === 'profile' && <ProfilePage profile={auth.profile} onSignOut={auth.signOut} />}
      </main>
